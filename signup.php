<?php
    ...
    if(isset($_POST['signup-full-name']) && isset($_POST['signup-email']) && isset($_POST['signup-password']) && isset($_POST['signup-cpassword']) && isset($_POST['signup-hackathon-code']))
    {
        if(empty($_POST['signup-full-name']) || empty($_POST['signup-email']) || empty($_POST['signup-password']) || empty($_POST['signup-cpassword']) || empty($_POST['signup-hackathon-code']))
        {
        ...
        {   
            ...
            $sql = "SELECT * FROM users WHERE email = '" . $_POST["signup-email"] . "'; ";
            ...
            else
            {
               if($_POST['signup-password'] == $_POST['signup-cpassword'])
               {
                   ...
                   $organizer = 0;
                   $sql_signup = "INSERT INTO users(email, password, full_name, hackathon_id, organizer) VALUES('" . $_POST["signup-email"] . "', '" . $password . "', '" . $_POST["signup-full-name"] . "', '" . $_POST["signup-hackathon-code"] . "', '" . $organizer . "'); ";
...
<html lang="en">
    ...
    <body>
        ...
        <form action="signup.php" method="POST" class="form-signup">
            ...
            <label for="signup-hackathon-code" class="sr-only">Hackathon Code</label>
            <input type="text" id="signup-hackathon-code" name="signup-hackathon-code" class="form-control" placeholder="Code">
